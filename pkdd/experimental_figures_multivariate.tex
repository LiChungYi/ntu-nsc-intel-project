...
\subfigure%[]
{
	...
	\includegraphics[height=2.6cm, trim=15 0 0 0, clip]{traffic_random_humidity_pspdftex}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_random_tem}
	\includegraphics[height=2.6cm, trim=15 0 0 0, clip]{traffic_random_temperature_pspdftex}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_temporal_hum}
	\includegraphics[height=2.6cm, trim=15 0 0 0, clip]{traffic_temporal_humidity_pspdftex}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_temporal_tem}
	\includegraphics[height=2.6cm, trim=15 0 0 0, clip]{traffic_temporal_temperature_pspdftex}
}
\vspace{-0.1in}
