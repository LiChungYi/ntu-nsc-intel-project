...
\subsection{Experimental Results on MTR-MF and TR-TF}
...
To evaluate multivariate imputation models, we use humidity information to improve temperature predictions and vice versa.
...
We consider two different scenarios in this experiment.
...
Except for MTR-MF-part, which exhibits a similar performance as TR-MF, we see significant improvement on TR-TF-all, TR-TF-part and MTR-MF-all. 
...
both temperature and humidity information can indeed be used to enhance the prediction of the other.
%
...
The results confirm our hypothesis that a better imputation model does lead to the production of a better prediction model, and TR-MF again outperforms the other models in this respect.
