...
compared to prior approaches for imputation, our method leads to a much higher quality prediction model.

%\keywords{Wireless Sensor Network, Missing Data Imputation, Matrix Factorization, Tensor Factorization}
\begin{IEEEkeywords}
Missing Data Imputation, Wireless Sensor Network, Recommendation Systems, Matrix Factorization, Tensor Factorization
\end{IEEEkeywords}
