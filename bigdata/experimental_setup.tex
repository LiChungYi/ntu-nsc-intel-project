...
We found the relative performance of the compared methods to be similar in these three cases; thus, we report only results of
...
\subfigure[\hbox{Intel Berkeley research lab floorplan}]{
	\label{berkeley_lab}
	\includegraphics[height=2.3cm]{berkeley_lab.eps}
}
