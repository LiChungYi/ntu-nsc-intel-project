...
\subfigure%[]
{
	...
	\includegraphics[height=2.6cm, trim=13 0 0 0, clip]{traffic_temporal_humidity_pspdftex.eps}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_temporal_tem}
	\includegraphics[height=2.6cm, trim=13 0 0 0, clip]{traffic_temporal_temperature_pspdftex.eps}
}
\vspace{-0.1in}
