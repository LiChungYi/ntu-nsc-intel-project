...
\redtext{
Here we include another dataset for comparison: London air quality dataset (\cite).
There are 64 sensors that measure the concentration of nitrogen dioxide (ug/m3) in London.}
\begin{table} [h]
