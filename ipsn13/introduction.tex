...
In DESM, the prediction on sensor $i$ is produced by the linear combination of previous readings from sensor $i$ and contemporary readings from its k-nearest neighbors. The coefficents used to combine those readings are a function of Pearson correlation among sensors.
