...
{\bf Temporal}&&ImM~\cite{Lim:robust}, EOF~\cite{beckers2003eof},\\
{\bf } &&BGP~\cite{Osborne2011}\\%{}&&&BGP~\cite{Osborne2011} \
 \hline \end{tabular}
}
\vspace{-0.1in}
\end{table}
...
AKE~\cite{pan2010k},BGP~\cite{Osborne2011} and Imputation Method~\cite{Lim:robust}.
%These
