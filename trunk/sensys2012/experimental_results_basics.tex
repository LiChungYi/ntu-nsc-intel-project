...
The result of comparison between TR-MF and EOF is in \ref{table:trmf_eof}. The high missing rate in sensory data influence the performance of EOF. The result reveals that the EOF is outperformed by TR-MF in both RMSE and computation time. 
\begin{table}[htbp]
