...
was Þrst introduced by Tucker in 1963 [1], it factorizes a higher-order tensor into a core tensor S and a factor matrix for each dimensions. we decompose a $m\times n \times c $ tensor T :
