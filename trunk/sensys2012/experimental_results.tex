...
\begin{tabular}{ r | r r r r r}
	train	&LI	&TRMF	&AKE	&DESM	&STI\\ \hline
	5\% & $ 3.967_{(4)} $ & $ 1.051_{(2)} $ & $ 1.449_{(3)} $ & $ 3.968_{(5)} $ & $ \mathbf{ 0.788_{(1)} } $ \\
...
\begin{tabular}{ r | r r r r r}
	train	&LI	&TRMF	&AKE	&DESM	&STI\\ \hline
	5\% & $ 330.6_{(4)} $ & $ 229.1_{(2)} $ & $ \mathbf{ 196.4_{(1)} } $ & $ 330.9_{(5)} $ & $ 251.3_{(3)} $ \\
...
\begin{tabular}{ r | r r r r r}
	train	&LI	&TRMF	&AKE	&DESM	&STI\\ \hline
	5\% & $ 3.087_{(4)} $ & $ 0.531_{(2)} $ & $ 0.531_{(3)} $ & $ 3.088_{(5)} $ & $ \mathbf{ 0.479_{(1)} } $ \\
...
\begin{tabular}{ r | r r r r r}
	train	&LI	&TRMF	&AKE	&DESM	&STI\\ \hline
	5\% & $ 16.643_{(4)} $ & $ 6.060_{(3)} $ & $ 5.396_{(2)} $ & $ 17.128_{(5)} $ & $ \mathbf{ 5.328_{(1)} } $ \\
...
\begin{tabular}{ r | r r r r r}
	train	&LI	&TRMF	&AKE	&DESM	&STI\\ \hline
	5\% & $ 8.677_{(5)} $ & $ 2.080_{(3)} $ & $ \mathbf{ 1.838_{(1)} } $ & $ 8.667_{(4)} $ & $ 1.989_{(2)} $ \\
