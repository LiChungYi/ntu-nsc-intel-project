...
Matrix Factorization is one of the most successful Collaborative Filtering~(CF) techniques in the area of Recommendation Systems [cite]. 
As we have shown in the introduction section Given a data matrix of observed and missing entries, the essence of Matrix Factorization~(MF) is to learn latent factors from the observed entries, and then leverage these factors to predict the missing entries.
