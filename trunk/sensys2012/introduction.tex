...
Data imputation techniques as applied to WSN datasets can be divided into two categories:
temporal methods (i.e.\ estimation using the observations from the target sensor at nearby time-steps) and 
