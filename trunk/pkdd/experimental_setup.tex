...
\begin{figure}[h]
\centering
\subfigure[Intel Berkeley Research Lab Floorplan]{
	\label{berkeley_lab}
	\includegraphics[scale=0.18]{berkeley_lab.png}
}
\hspace{0.5cm}
\subfigure[Traffic Sensor Deployment Map (8 sensors of 20 shown)]{
	\label{fig:traffic}
	\includegraphics[scale=0.45]{traffic_wsn.png}
}
