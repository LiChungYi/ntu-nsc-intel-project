...
\subfigure%[]
{
	...
	\includegraphics[width=3.9cm, height=2.6cm, trim=20 0 0 0, clip]{traffic_random_humidity_pspdftex.eps}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_random_tem}
	\includegraphics[width=3.9cm, height=2.6cm, trim=20 0 0 0, clip]{traffic_random_temperature_pspdftex.eps}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_temporal_hum}
	\includegraphics[width=3.9cm, height=2.6cm, trim=18 0 0 0, clip]{traffic_temporal_humidity_pspdftex.eps}
}
\hspace{0in}
\subfigure%[]
{
	\label{fig:multi_traffic_temporal_tem}
	\includegraphics[width=3.9cm, height=2.6cm, trim=13 0 0 0, clip]{traffic_temporal_temperature_pspdftex.eps}
}
\vspace{-0.1in}
