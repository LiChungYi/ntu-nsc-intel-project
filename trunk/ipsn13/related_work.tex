...
Recently, a random process method,  called Bayesian Gaussian Process model, had been proposed~\cite{osborne2012real}. However, its performance depends on a convariance function from prior knowledge. Conversely, we focus on more general propose system to impute sensor reading without domain knowledges. By the reason, we do not compare with BGP in our experiment.
