...
AKE adopts linear regression models to describe the spatial correlation among nodes. The prediction of target node is the combination of the regression models from K-nearest nodes. If there are no enougth data to describe spatial information, AKE use temporal regression model instead.
%\begin{center}
