...
Improved EOF is significantly better than EOF, but still worse than our TR-MF.
EOF results were not generated for other experiments because EOF requires the execution of many rounds of SVD, which is computational expensive and much less efficient compared with other models.
...
\begin{tabular}{ r | r r r r r r}
		&10\%	&20\%	&40\%	&60\%	&80\% \\ 
	 \hline
	 TR-MF & 0.142 &0.114 &0.092&0.082&0.076 \\
     	 EOF &2.423 &1.385 &1.000 &0.734 &0.656 \\
     Improved EOF & 0.362 & 0.237 & 0.183 & 0.152 & 0.136 \\
\end{tabular}
\end{table}

Then, we compare our TR-MF with conventional MF (i.e., MF without temporal regularization), Linear Interpolation~(LI), 
...
Also, we omit the result of light sensors on Berkeley dataset (in which TR-MF performs equally well as in other cases) due to space limit. 
