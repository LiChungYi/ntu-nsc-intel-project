...
\begin{equation}\frac{q_{n_i}^T q_{n_j}}{max(||q_{n_i}||^2, ||q_{n_j}||^2)}\end{equation},
...
\subfigure[Humidity: top 100 similar pairs]{
	\includegraphics[width=0.5\textwidth]{Hum_similarity.png}
}
\hspace{1in}
\subfigure[Light: top 100 similar pairs]{
	\includegraphics[width=0.5\textwidth]{Light_similarity.png}
}
\end{figure}
